...
namespace ApiCatalogoJogos.Controllers.V1
{
    ...
    public class CicloDeVidaController : ControllerBase
    {
        ...
        public CicloDeVidaController(IExemploSingleton exemploSingleton1, IExemploSingleton exemploSingleton2, IExemploScoped exemploScoped1, IExemploScoped exemploScoped2, IExemploTransient exemploTransient1, IExemploTransient exemploTransient2)
        {
    ...
    public class ExemploCicliDeVida : IExemploSingleton, IExemploScoped, IExemploTransient
    {
        private readonly Guid _guid;

        public ExemploCicliDeVida()
        {
            _guid = Guid.NewGuid();
        }
