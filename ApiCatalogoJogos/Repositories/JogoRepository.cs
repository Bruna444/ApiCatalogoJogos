...
namespace ApiCatalogoJogos.Repositories
{
    public class JogoRepository : IJogoRepository
    {
        ...
        {
            {Guid.Parse("0ca314a5-9282-45d8-92c3-2985f2a9fd04"), new Jogo{ Id = Guid.Parse("0ca314a5-9282-45d8-92c3-2985f2a9fd04"), Nome = "The Sims 3", Produtora = "EA", Preco = 100} },
            {Guid.Parse("eb909ced-1862-4789-8641-1bba36c23db3"), new Jogo{ Id = Guid.Parse("eb909ced-1862-4789-8641-1bba36c23db3"), Nome = "The Sims 4", Produtora = "EA", Preco = 300} },
